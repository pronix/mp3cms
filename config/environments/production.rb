...
ExceptionNotifier.configure_exception_notifier do |config|
  config[:exception_recipients]     = %w(pronix.service@gmail.com parallel588@gmail.com)
end

ExceptionNotifier.configure_exception_notifier do |config|
  config[:app_name]                 = "mp3koza.com"
  config[:sender_address]           = "error@mp3koza.com"
  config[:exception_recipients]     = ["pronix.service@gmail.com", "parallel588@gmail.com"]
