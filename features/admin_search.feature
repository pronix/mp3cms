...
Функционал: Поиск в административной панели
  ...
  Предыстория:
    И в сервисе есть следующие пользователи:
     | login      | email                | password | active | roles       | id |
     | admin      | admin_user@gmail.com | secret   | true   | user, admin |  1      |
     | petr       | petr@gmail.com       | secret   | true   | user        |  2      |
...
#======== STOP_MP3 ====================
#======== START_USERS ====================
Сценарий: Поиск а админке пользователей
