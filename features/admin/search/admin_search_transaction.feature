...
Сценарий: Нулевой запрос
  Допустим я нажму "Найти" в "#form_transaction"
...
Сценарий: Поиск по типу транзакции "Доход"
  ...
  И я нажму "Найти" в "#form_transaction"
...
Сценарий: Поиск по кошельку с большым значением
  ...
  И я введу в поле "search_transaction" значение "10.65"
  И я нажму "Найти" в "#form_transaction"
  И я увижу "10.66"
  И я увижу "15.66"
  И я увижу "20.55"
...
Сценарий: Поиск по кошельку с меньшим значением
  ...
  И я введу в поле "search_transaction" значение "15.67"
  И я нажму "Найти" в "#form_transaction"
  И я увижу "10.66"
  И я увижу "15.66"
  И я увижу "5.55"
...
Сценарий: Поиск по кошельку с равным значением
  ...
  И я введу в поле "search_transaction" значение "15.66"
  И я нажму "Найти" в "#form_transaction"
  И я увижу "15.66"
  И я не увижу "10.66"
  И я не увижу "5.55"
...
Сценарий: Поиск по пользователю
  ...
  И я введу в поле "search_transaction" значение "petr"
  И я нажму "Найти" в "#form_transaction"
  И я увижу "petr"
  И я не увижу "anna"
