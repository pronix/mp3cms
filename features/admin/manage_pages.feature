...
Функционал: Управление статическими страницами
  ...
  Сценарий: Просмотр списка страниц
    ...
    |  1 | О нас    | about    | Редактировать Удалить |
    |  2 | Контакты | contact  | Редактировать Удалить |
  ...
  Сценарий: Добавление новой страници
    ...
    И введу в поле "page[content]" значение
    """
    Такое вот пользовательское соглашение.
    """
  ...
  Сценарий: Редактирование статической страницы.
    ...
    | Ид | Название    | Ссылка  | Действия              |
    |  1 | О нас       | about   | Редактировать Удалить |
    |  2 | Снова о нас | contact | Редактировать Удалить |
