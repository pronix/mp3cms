Feature: Manage payouts
  ...
  Scenario: Register new payouts
    Given I am on the new payouts page
    And I press "Create"
  ...
  #
  @culerity
  Scenario: Delete payouts
    Given the following payouts:
      ||
      ||
      ||
      ||
      ||
    When I delete the 3rd payouts
    Then I should see the following payouts:
      ||
      ||
      ||
      ||
