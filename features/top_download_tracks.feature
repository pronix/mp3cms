...
Функционал: Топ скачанных файлов за последние 7 дней
  ...
  Сценарий: Просмотра топа мп3 на главной
    ...
    И я перейду по ссылке "Топ MP3"
    То я увижу табличные данные в "#tracks":
     | 1 . | С. Наговицын | Городские встречи  | 320 кб/с | 850 КБ |
     | 2 . | С. Наговицын | Девочка-проказница | 320 кб/с | 850 КБ |
     | 3 . | Scorpions    | Wind of change     | 320 кб/с | 850 КБ |
     | 4 . | Scorpions    | Send Me An Angel   | 320 кб/с | 850 КБ |
     | 5 . | Мираж        | Музыка нас связала | 320 кб/с | 850 КБ |
