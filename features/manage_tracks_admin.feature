...
Функционал: Работа с файлами (треками) со стороны админа
  ...
  Сценарий: Модерация новых файлов массово
      Если я выберу треки "Городские встречи, Девочка-проказница"
          И я нажму "Забанить"
      ...
      Если я перейду по ссылке "Забаненные"
      И я выберу треки "Городские встречи, Девочка-проказница"
      И я нажму "active"
  ...
  Сценарий: Редактирование файлов администратором
      ...
      То будет сообщение "Трек обновлен"
        И я увижу "Гарадские фстречи"
        И я увижу "Нагавицын"
