Feature: Manage mobilcents
  In order to [goal]
  [stakeholder]
  wants [behaviour]
  
  Scenario: Register new mobilcents
    Given I am on the new mobilcents page
    And I press "Create"
  ...
  #
  @culerity
  Scenario: Delete mobilcents
    Given the following mobilcents:
      ||
      ||
      ||
      ||
      ||
    When I delete the 3rd mobilcents
    Then I should see the following mobilcents:
      ||
      ||
      ||
      ||
