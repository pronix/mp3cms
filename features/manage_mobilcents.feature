# language: ru
 Функционал: Пополнение баланса пользователем через mobolcents
  ...
  Сценарий: Пользователь должен увидеть информацию для выполнения платежа (номер телефона, код смс)
    ...
    То я увижу "Выберите страну"
    Если я выберу "Россия" из "country"
    То я увижу "Для пополнения баланса на сумму 10.00(ye), отправьте смс на номер 2474 с текстом dat 10229"
