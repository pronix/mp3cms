# language: ru
 Функционал: Комментарии к новостям
  ...
  | 1  | Открыт новый сервис на проекте  | Вы можете заработать | Зарабатывайте вместе с нами  | Новый сервис рулит |
  | 2  | Топ10 нашего сайта    | Признан самым актуальным | Независимый источник признал наш Топ10 | Top10 рулит |
  | 3  | 100 топовый треков прошлого года | Что признал народ | Статистика скаченных треков за прошлый год | Статистика дескрипшен |
