...
Сценарий: Поиск треков с нулевым запросом
  ...
  И я выберу "attribute_everywhere" в "#search_track"
  И я нажму "Найти" в "#search_track"
  То я увижу "По вашему запросу ничего не найденно"

Сценарий: Поиск а админке треков с нулевым результатом
