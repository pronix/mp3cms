...
Сценарий: Поиск в админке пользователей по ip
  Допустим я на странице "поиск по пользователей в админке"
  И я введу в поле "search_string" значение "127.0.0.1"
...
Сценарий: Удаление аккаунта
  Допустим я на странице "поиск по пользователей в админке"
  И я введу в поле "search_string" значение "anna"
  И я выберу "attribute_login"
  И я нажму "Найти"
  То я увижу "anna"
  И я перейду по ссылке "Удалить аккаунт"
  И я не увижу "anna"
...
Сценарий: Редактирование аккаутна
  ...
  И я нажму "Найти"
  То я увижу "anna"
  И я перейду по ссылке "Редактирование аккаунта"
