...
Функционал: Регистрация пользователя
  ...
  Сценарий: Регистрация пользователя с пустым login.
    ...
    И нажму "user_submit"
    То я увижу сообщение ошибки "не может быть пустым" для поля "login" модели "User"
  ...
  Сценарий: Регистрация пользователя с пустым password.
   Допустим я на главной странице сервиса
    ...
    И нажму "user_submit"
    То я увижу сообщение ошибки "не может быть пустым" для поля "password" модели "User"
